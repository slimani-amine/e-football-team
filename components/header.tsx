    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <a className="flex items-center gap-2" href="/">
          <img src="/images/barba-blanca-logo.png" alt="BRC Logo" className="h-8 w-8" />
          <span className="font-playfair font-bold text-xl">Barba Blanca FC</span>
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <a href="/highlights" className="text-foreground hover:text-primary transition-colors">
            Highlights
          </a>
        </nav>

        <div className="flex items-center gap-4">
          <Button className="hidden md:inline-flex" onClick={() => (window.location.href = "/join")}>
            Join the Clan!
          </Button>
